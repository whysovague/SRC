...
export const AGENDA_DAYS: {
...
}[] = [
  {
    ...
    items: [
      ...
      { time: "10:00 am - 12:15 pm", start: 600, title: "KFUPM & Chemical Engineering Campus Tour", track: "Youth", note: "around campus" },
      { time: "12:45 - 2:00 pm", start: 765, title: "Science Olympiad", track: "Youth", note: "stage · B54" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "6:45 - 7:35 pm", start: 1125, title: "International training program talk", track: "Undergraduate", note: "stage" },
