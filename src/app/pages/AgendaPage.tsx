...
export const AGENDA_DAYS: {
...
}[] = [
  {
    ...
    weekday: "Monday",
    items: [
      { time: "8:30 - 9:00 am", start: 510, title: "Registration & Check-in", track: "Youth", note: "B54" },
      { time: "9:05 - 9:20 am", start: 545, title: "Opening ceremony", track: "Youth", note: "stage · B54" },
      { time: "9:20 - 9:50 am", start: 560, title: "Intro to ChemE", track: "Youth", note: "stage · B54" },
      { time: "9:50 - 9:55 am", start: 590, title: "Closing of Opening ceremony", track: "Youth", note: "stage · B54" },
      { time: "10:00 - 11:00 am", start: 600, title: "KFUPM & Chemical Engineering Campus Tour", track: "Youth", note: "around campus" },
      { time: "11:10 am - 12:10 pm", start: 670, title: "Science Olympiad", track: "Youth", note: "stage · B54" },
      { time: "1:00 - 1:15 pm", start: 780, title: "Registration & Check-in", track: "Undergraduate" },
      { time: "1:15 - 1:30 pm", start: 795, title: "Opening ceremony", track: "Undergraduate", note: "stage · B54" },
      { time: "1:30 - 1:55 pm", start: 810, title: "Keynote Speaker 1: Abdullah AlBudair", track: "Undergraduate", note: "stage · B54" },
      { time: "2:00 - 2:25 pm", start: 840, title: "Keynote Speaker 2: Mohammed bin Shams", track: "Undergraduate", note: "stage · B54" },
      { time: "2:30 - 3:20 pm", start: 870, title: "Engineering in Consultancy Panel Talk", track: "Undergraduate", note: "stage · B54" },
      { time: "3:20 - 3:25 pm", start: 920, title: "Closing of Opening ceremony", track: "Undergraduate", note: "stage · B54" },
      { time: "3:25 - 4:00 pm", start: 925, title: "Prayer Break", track: "Undergraduate" },
      { time: "4:00 - 5:00 pm", start: 960, title: "Chem-E-Jeopardy Round 1", track: "Undergraduate", note: "stage · B54" },
      { time: "5:10 - 6:10 pm", start: 1030, title: "Chem-E-Jeopardy Round 2", track: "Undergraduate", note: "stage · B54" },
  ...
  },
  {
    ...
    weekday: "Tuesday",
    items: [
      { time: "8:30 - 9:00 am", start: 510, title: "Registration & Check-in", track: "Youth" },
      { time: "9:00 - 9:40 am", start: 540, title: "Fresh vs Experienced Graduate Talk", track: "Youth", note: "stage · B54" },
      { time: "9:45 am - 12:15 pm", start: 585, title: "KFUPM & Chemical Engineering Campus Tour", track: "Youth", note: "around campus" },
      { time: "12:20 - 2:00 pm", start: 740, title: "Youth Poster Competition", track: "Youth", note: "B54" },
      { time: "3:00 - 3:30 pm", start: 900, title: "Poster Set Up", track: "Undergraduate" },
      { time: "3:30 - 3:45 pm", start: 930, title: "Registration & Check-in", track: "Undergraduate" },
      { time: "4:00 - 5:00 pm", start: 960, title: "Chem-E-Car Poster Competition & Safety Inspection", track: "Undergraduate", note: "B54" },
      { time: "4:00 - 5:00 pm", start: 960, title: "Engineering game show", track: "Undergraduate", note: "B54 · stage" },
  ...
  },
  {
    ...
    items: [
      { time: "8:30 - 9:00 am", start: 510, title: "Registration & Check-in", track: "Youth" },
      { time: "9:00 - 9:45 am", start: 540, title: "Women in STEM", track: "Youth" },
      { time: "9:50 - 11:50 am", start: 590, title: "KFUPM & Chemical Engineering Campus Tour", track: "Youth" },
      { time: "11:50 - 1:00 pm", start: 710, title: "Students visit Undergrad Research Posters", track: "Youth" },
      { time: "1:15 - 2:00 pm", start: 795, title: "Award Ceremony & Closing (youth)", track: "Youth" },
      { time: "3:30 - 3:45 pm", start: 930, title: "Registration & Check-in", track: "Undergraduate" },
      { time: "4:00 - 5:00 pm", start: 960, title: "Mock Interviews", track: "Undergraduate", note: "B54 · Room 004" },
      { time: "4:00 - 5:00 pm", start: 960, title: "Tabaqat 3D printing workshop", track: "Undergraduate" },
      { time: "4:00 - 6:25 pm", start: 960, title: "Chem-E-Car Competition", track: "Undergraduate", note: "B54" },
      { time: "5:00 - 7:00 pm", start: 1020, title: "Student Technical Presentation Competition", track: "Undergraduate", note: "Room 004" },
      { time: "6:25 - 6:45 pm", start: 1105, title: "Prayer Break", track: "Undergraduate" },
      { time: "6:45 - 7:35 pm", start: 1125, title: "International Training Programs & Young Scholar Fellowship Talk", track: "Undergraduate", note: "stage" },
      { time: "7:35 - 8:00 pm", start: 1175, title: "Prayer Break", track: "Undergraduate" },
      { time: "8:30 - 10:00 pm", start: 1230, title: "Award Banquet", track: "Undergraduate", note: "B54 · stage" },
    ],
  },
];

export const AGENDA_ALL_DAY: { title: string; days: number[]; time?: string }[] = [
  // Kept in the same day sections as the organising team's agenda spreadsheet.
  { title: "Sponsor Exhibition/Booths", days: [1, 2, 3] },
  { title: "Big SRC-AIChE letters", days: [1, 2, 3] },
  { title: "Passport", days: [1, 2, 3] },
  { title: "Mini-experiment stations", days: [1, 2, 3] },
  { title: "Presidents Meeting", days: [2], time: "2:00 - 3:00 pm" },
  { title: "Poster Engagement Game", days: [2] },
  { title: "Air products Site Visit — Undergrad", days: [3], time: "10 am to 12 pm" },
